...
5. If during the script execution an error (i.e., "*java.io.FileNotFoundException*") is raised, please i) stop the script, ii) remove all output files, and iii) restart the script with a decreased number of parallel executions (i.e., line 16).
