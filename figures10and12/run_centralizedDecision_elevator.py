...
# Constants
PATTERNNAME = 'centralizedDecision_stairsElevator'
...
###### Robot parameters ######
AVAIL_ROBOT = 100 #N
ROBOT_WITH_LEGS = [80] #N_two_legged
...
###### Communication Cost ######
COMM_SAME_ROOM = [1] #mu_follow = mu_fail = mu_ask
